...
import { THUMBNAIL_CALLBACK } from "@/modules/videos/constants";
  ...
  return (
    <div className={cn("relative pt-3", className)}>
      ...
      <div className="relative">
        ...
        <div className="relative w-full overflow-hidden rounded-xl aspect-video">
          <Image src={imageUrl || THUMBNAIL_CALLBACK} alt={title} className="w-full h-full object-cover" fill />
        </div>

        <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out rounded-xl flex items-center justify-center">
