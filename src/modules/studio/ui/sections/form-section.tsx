...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
  ...
  return (
    <>
      <ThumbnailUploadModal isOpen={thumbnailModalOpen} onOpenChange={setThumbnailModalOpen} videoId={videoId} />
      <Form {...form}>
                ...
                render={() => {
                  return (
                    <div className="p-0.5 border border-dashed border-neutral-400 relative h-[84px] w-[153px] group">
                      <Image
                        src={video.thumbnailUrl || THUMBNAIL_CALLBACK}
                        fill
                        alt="Thumbnail"
                ...
                <div className="p-4 flex flex-col gap-y-6">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex flex-col gap-y-1">
                      ...
                      <p>{snakeCaseToTitleCase(video.muxStatus)}</p>
                    </div>
                  </div>
                  <div className="flex justify-between items-center">
                    <div className="flex flex-col gap-y-1">
                      <p className="text-muted-foreground text-xs">Subtitles Status</p>
                      <p>{snakeCaseToTitleCase(video.muxTrackStatus || "no_subtitles")}</p>
                    </div>
                  </div>
                </div>
              </div>
